 ...
 * Description: A widget that displays flickr items
 * Version: 1.0
 * Author: HB-Themes
...
class hb_flickr_widget extends WP_Widget {
	...
	function HB_Flickr_Widget() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'flickr-widget', 'description' => __('A widget that displays your flickr posts.', 'hbthemes') );
		$control_ops = array ();
		/* Create the widget. */
		$this->WP_Widget( 'hb_flickr_widget', __('Custom Flickr Widget','hbthemes'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- Number: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php echo 'Dribbble Item Number: '; ?></label>
